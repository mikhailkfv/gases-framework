...
{
	/*
	 * Add a config option in the section modname with displayed text configtext
	 * and access key keyname
	 */
	...
	/*
	 * Selective NBT key syncing. Will register a key to sync over the network
	 * for the given class (block, te or ent). Accept * as a ending wildcard
	 * registerNBTKey("bob.*", MyBlock.class) registerNBTKey("data.life",
	 * MyEntity.class) registerNBTKey("*", MyTileEntity.class) will reproduce
	 * the full tag syncing from 1.4.5 This registration method is deprecated in
	 * favor to registerNBTProvider. It will be removed in MC 1.8 !!!
	 */
	@Deprecated
	...
	// public void registerShortDataProvider (IWailaSummaryProvider
	// dataProvider, Class item);
}
