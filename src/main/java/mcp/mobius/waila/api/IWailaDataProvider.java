...
public interface IWailaDataProvider
{
	...
	/**
	 * Callback used to add lines to one of the three sections of the tooltip
	 * (Head, Body, Tail).</br>
	 * Will be used if the implementing class is registered via
	 ...
	 * @param currenttip
	 *            Current list of tooltip lines (might have been processed by
	 ...
	 * side.</br>
	 * You are supposed to always return the modified input NBTTagCompound
	 * tag.</br>
	 * 
	 * @param player
	 ...
	 * @param tag
	 *            Current synchronization tag (might have been processed by
	 *            other providers and might be processed by other providers).
	 * @param world
	 *            TileEntity's World.
	 * @param x
