...
import glenn.gasesframework.ReactionIgnition;
...
/**
 * To allow a gas to flow in pipes, create a {@link glenn.gasesframework.block.BlockGasPipe BlockGasPipe} for the gas.
 * @author Glenn
 */
public class BlockGas extends Block implements ISample
{
    ...
    /**
     * Called whenever a gas {@link glenn.gasesframework.ReactionIgnition reacts} with a block registered with {@link GasesFramework#registerIgnitionBlock(Block)}. Does not necessarily trigger as a gas block.
     * @param world
     * @param i
     * @param j
     * @param k
    ...
    {
    	if(!world.provider.isHellWorld & par3 > GasesFramework.configurations.gases_maxGasHeight)
    	{
