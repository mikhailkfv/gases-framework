...
{
	/**
	 * Register a furnace recipe that only applies to gas furnaces. A gas
	 * furnace recipe will always be prioritized before an ordinary furnace
	 * recipe.
	 * 
	 * @param ingredient
	 *            The item that can be smelted. Can be more than 1
	 * @param result
	 *            The result of the smelting action
	 * @param time
	 *            The amount of time it takes to smelt. Default is 200
	 * @param exp
	...
	/**
	 * Returns true if the block is a gas igniting block, e.g. a block which can
	 * cause a gas to combust or explode.
	 * 
	 * @param block
	...
	/**
	 * Register a block as a gas igniting block, e.g. a block which can cause a
	 * gas to combust or explode.
	 * 
	 * @param block
	 *            The block
	 */
	...
	/**
	 * Unregister a block as a gas igniting block, e.g. a block which can cause
	 * a gas to combust or explode.
	 * 
	 * @param block
	 *            The block
	 */
	...
	/**
	 * Get an array of all gas igniting blocks, e.g. blocks which can cause a
	 * gas to combust or explode.
	 * 
	...
	/**
	 * Returns true if the item is a gas igniting item, e.g. an item which can
	 * cause a gas to combust or explode when held, equipped or dropped.
	 * 
	 * @param item
	...
	/**
	 * Register an item as a gas igniting item, e.g. an item which can cause a
	 * gas to combust or explode when held, equipped or dropped.
	 * 
	 * @param item
	 *            The item
	 */
	...
	/**
	 * Unregister an item as a gas igniting item, e.g. an item which can cause a
	 * gas to combust or explode when held, equipped or dropped.
	 * 
	 * @param item
	 *            The item
	...
	/**
	 * Get an array of all gas igniting items, e.g. items which can cause a gas
	 * to combust or explode when held, equipped or dropped.
	 * 
	...
	/**
	 * Register a reaction for a set of gas types. Reactions must be registered
	 * during {@link cpw.mods.fml.common.event.FMLInitializationEvent
	 * Initialization}.
	 * 
	 * @param reaction
	 *            The reaction to register to the gas types
	 * @param gasTypes
	 *            The gas types to register the reaction to
	 */
	...
	/**
	 * Registers a gas type. This involves creating and registering the blocks
	 * necessary for a gas type. Gas types must be registered during
	 * {@link cpw.mods.fml.common.event.FMLPreInitializationEvent
	 * PreInitialization}.
	 * 
	 * @param type
	 *            The gas type
	...
	/**
	 * Registers a lantern type. This involves creating and registering the
	 * blocks necessary for a lantern type. Lantern types must be registered
	 * during {@link cpw.mods.fml.common.event.FMLPreInitializationEvent
	 * PreInitialization}.
	 * 
	 * @param type
	 *            The lantern type
	...
	/**
	 * Register a recipe for a lantern type. This will override conflicting
	 * registered inputs. Lantern inputs must be registered during
	 * {@link cpw.mods.fml.common.event.FMLInitializationEvent Initialization}.
	 * 
	 * @param type
	 *            The lantern type
	 * @param itemKey
	 *            The item that can be put in the lantern
	 */
	 ...
	 * 
	 * @param type
	 *            The world gen type to register
	 */
	 ...
	 * 
	 * @param type
	 *            The world gen type in question
	 * @param dimension
	 ...
	 * 
	 * @param handler
	 *            The gas transposer handler in question
	...
	/**
	 * Registers a pipe type. Pipe types must be registered during PreInit.
	 * 
	 * @param type
	 *            The pipe type
	 */
