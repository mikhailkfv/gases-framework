...
public interface IGasesFrameworkImplementation
{
	 ...
	 * If the block is an IGasTransporter or IGasReceptor, {@link IGasesFrameworkImplementation#pumpGas(World,int,int,int,GasType,ForgeDirection,int) pumpGas(World,int,int,int,GasType,ForgeDirection,int)} is returned.
	 * Else, {@link IGasesFrameworkImplementation#fillWithGas(World,int,int,int,GasType) fillWithGas(World,int,int,int,GasType)} is returned.
	 * @param world
	 * @param random
	 * @param x
	 * @param y
