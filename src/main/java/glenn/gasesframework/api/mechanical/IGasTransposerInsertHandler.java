...
/**
 * Handles the insertion operation of a gas transposer. Must be registered
 * through
...
{
	/**
	 * Is this a valid item to insert gas into? Must not check the size of the
	 * itemstack.
	 * 
	 * @param itemstack
	...
	/**
	 * Is this a valid gas to insert into this item? Can check the size of the
	 * itemstack. This will only be called if
	 * {@link #isValidInsertionInput(ItemStack)} returns true.
	 * 
	 * @param inputStack
	 *            The itemstack in the input slot. Should not be modified
	 * @param gasType
	 *            The gas type that will be inserted into the item
	 ...
	 * If false is returned, the insertion will be delayed until true is
	 * returned.
	 * 
	 * @param inputStack
	...
	/**
	 * If {@link #completeInsertion(ItemStack, ItemStack, GasType)} returns
	...
	/**
	 * Get the amount of ticks required to complete this insertion. Commonly set
	 * to 20.
	 * 
