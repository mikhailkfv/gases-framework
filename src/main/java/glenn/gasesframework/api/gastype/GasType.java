...
public class GasType
{
	...
	/**
	 * The ID of this gas type. Must be unique. Limited to 0-255. Consult the
	 * Gases Framework documentation for unoccupied IDs.
	 */
	...
	/**
	 * The ability of the gas to stick together. Only applies to 0-density
	 * gases. Limited to 0-16. Higher values mean the gas will have a higher
	 * threshold of volume before spreading in midair.
	 */
	public int cohesion;
	/**
	...
	/**
	 * The density of this gas type. A negative density will make a rising gas.
	 * A positive density will make a falling gas. If The density is 0, the gas
	 * will spread evenly in all directions.
	 */
	public final int density;

	/**
	 * The combustibility of this gas. See
	 * {@link glenn.gasesframework.api.Combustibility Combustibility}.
	 */
	public final Combustibility combustibility;
	/**
	 * How quickly this gas type will dissipate in the world. Higher values will
	 * decrease dissipation speed. If 0, it does not dissipate.
	 */
	public int dissipationRate = 0;
	/**
	 * Will this gas type, when flowing, destroy loose blocks such as redstone,
	...
	/**
	 * The name of the texture that will be used on the gas block. Default
	 * "gasesframework:gas".
	 */
	...
	/**
	 * Create a new gas type. Gas types must be
	 * {@link IGFRegistry#registerGasType(GasType) registered}.
	 * 
	 * @param isIndustrial
	 *            Can this gas be used in pipe systems?
	 * @param gasID
	 *            The ID of this gas type. Must be unique. Limited to 0-255.
	 *            Consult the Gases Framework documentation for unoccupied IDs
	 * @param name
	 *            An unique name for the gas type
	 * @param color
	 *            An RGBA hex representation of the color to be used by this gas
	 * @param opacity
	 *            Higher values will increase the opacity of this gas. This will
	 *            also affect how well light passes through it
	 * @param density
	 *            A value determining how dense the gas will be relative to air
	 *            <ul>
	 *            <li><b>density > 0</b> Will produce a falling gas. Greater
	 *            values means the gas will fall faster</li>
	 *            <li><b>density < 0</b> Will produce a rising gas. Lower values
	 *            means the gas will rise faster</li>
	 *            <li><b>density = 0</b> Will produce a floating gas which will
	 *            spread in all directions</li>
	 *            </ul>
	 * @param combustibility
	 *            The grade of combustibility of this gas type
	 */
	 ...
	 * 
	 * @param effectType
	 *            The effect type which is to be added to the gas
	 * @param value
	 *            The rate at which this effect will be applied. Greater numbers
	 *            trigger the effects more quickly
	 * @return this
	 */
	...
	/**
	 * Get the rate of a gas effect on this gas type. All effect rates are 0 by
	 * default.
	 * 
	 * @param effectType
	 *            The effect type
	...
	/**
	 * Set how quickly the gas can dissipate. Higher values will decrease
	 * dissipation speed.
	 * 
	...
	/**
	 * Sets the ability of the gas to stick together. Only applies to 0-density
	 * gases. Limited to 0-16. Higher values mean the gas will have a higher
	 * threshold of volume before spreading in midair.
	 * 
	 * @param cohesion
	...
	/**
	 * Set whether this gas type, when flowing, will destroy loose blocks such
	 * as redstone and torches. If true, the gas can destroy blocks with
	 * materials on the condition
	 * {@link net.minecraft.block.material.Material#getMaterialMobility()
	 * getMaterialMobility()} == 1. If false, the gas can destroy blocks with
	 * materials on the condition
	 * {@link net.minecraft.block.material.Material#isReplaceable()
	 * isReplaceable()}.
	 * 
	 * @param destroyLooseBlocks
	 *            Destroy loose blocks
	 * @return this
	 */
	...
	/**
	 * Apply effects onto an entity when breathed. A gas is breathed when the
	 * player runs out of air in their hidden air meter. How quickly this
	 * happens, and how frequently this method is called depends on this gas
	 * type's rate of suffocation.
	 * 
	 * @param entity
	 *            The entity that is breathing the gas
	 */
	 ...
	 * 
	 * @param thisVolume
	 *            The volume of this gas block
	 * @param type
	 *            The type of gas attempting to flow into this one
	 * @param otherVolume
	 *            The volume of the other gas block
	 ...
	 *            The world object
	 * @param x
	 *            The X coordinate this gas can flow to
	 * @param y
	 *            The Y coordinate this gas can flow to
	 * @param z
	 *            The z coordinate this gas can flow to
	 * @param volume
	 *            The volume of this gas block
	...
	/**
	 * Get the dissipation of a gas. This triggers every time the gas block
	 * ticks. This is affected by the {@link #dissipationRate} of the GasType.
	 * 
	 * @param world
	 *            The world object
	 * @param x
	...
	/**
	 * Called at the end of the gas block tick. If true is returned, a new tick
	 * will happen.
	 * 
	 * @param world
	 *            The world object
