...
public abstract class ReactionBase extends Reaction
{
	...
	/**
	 * Constructs a new reaction between the specified blocks. One of the blocks should be a {@link glenn.gasesframework.block.BlockGas}, otherwise the reaction will never occur
