...
public class ReactionGasMix extends ReactionBase
{
	...
	public ReactionGasMix(int priority, Block gas1, Block gas2, Block newBlock)
	{
		super(priority, gas1, gas2);
	...
	protected boolean reactBlock1(World world, Random random, int blockX, int blockY, int blockZ)
	{
		...
		world.setBlock(blockX, blockY, blockZ, newBlock, metadata, 3);
		return true;
	}
