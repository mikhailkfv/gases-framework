...
public interface IGasTransporter extends IGasInterface
{
	...
	/**
	 * Set the type carried by this gas transporter.
	 * May change the block at the coordinate as long as it is still an IGasTransporter
	 * @param world The world object
	 * @param x X coordinate
	 * @param y Y coordinate
	 * @param z Z coordinate
	 * @param type The type to carry
	 ...
	 * @param y Y coordinate
	 * @param z Z coordinate
	 * @param pressure The pressure to handle
	 */
