...
public class GasWorldGenPocket extends GasWorldGenType
{
	...
	/**
	 * Creates a new gas world gen pocket. Gas world gen types are necessary for
	 * adding gases to the terrain. If the Gases Framework retrogen is enabled,
	 * this type will be generated in chunks where it has not previously been
	 * generated. In order for replaceBlocks to work, pocket world gen types
	 * initialized during
	 ...
	 *            The average amount of pockets/clouds per 16x16x16 chunk of
	 *            blocks
	 * @param averageVolume
	 *            The average number of gas blocks of the gas pockets/clouds
	 *            this will generate
	 * @param evenness
	 *            The evenness of the gas pocket/cloud. 0.0f gives very uneven
	 *            gas pockets/clouds. 1.0f gives completely round gas
	 *            pockets/clouds
	 * @param minY
	 ...
	 * @param replaceBlocks
	 *            Blocks replaceable by this gas pocket. Strings will be
	 ...
	 *            The greater this value is, the more central this block of gas
	 *            is.
	...
	public int getPlacementVolume(World world, int x, int y, int z, float placementScore)
	{
		if (this.replaceBlocks.contains(world.getBlock(x, y, z)))
		{
			...
			{
				if (GFAPI.implementation.getGasType(world, x, y, z) != gasType)
				{
