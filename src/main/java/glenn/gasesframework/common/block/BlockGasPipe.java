...
public class BlockGasPipe extends Block implements IGasTransporter
{
	...
	/**
	 * Constructs a new gas pipe block. Because of technical reasons, each type
	 * of gas needs its own gas pipe block for pipe usage.
	 * 
	 * @param type
	 */
	...
	{
		return Item.getItemFromBlock(GasesFramework.registry.getGasPipeBlock(GFAPI.gasTypeAir));
	}
