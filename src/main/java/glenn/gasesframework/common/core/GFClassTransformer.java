...
public class GFClassTransformer implements IClassTransformer
{
	...
	public byte[] patchClassEntityLivingBase(byte[] data, boolean obfuscated)
	{
		...
		
		{
			...
			method.instructions.add(new MethodInsnNode(INVOKEVIRTUAL, "glenn/gasesframework/api/ExtendedGasEffectsBase", "get", "(Lglenn/gasesframework/api/ExtendedGasEffectsBase$EffectType;)I"));
