	...
	public ItemStack transferStackInSlot(EntityPlayer entityPlayer, int slotIndex)
	{
		...
		if (slot != null && slot.getHasStack())
		{
			...
			else
			{
				...
				{
					// This input can apply to the input slot of the gas
					// transposer
				...
				{
					// This is from the player's main inventory and should be
				...
				{
					// This is from the player's action bar and should be placed
