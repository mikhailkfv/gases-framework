...
{
	NORTH_FORWARD(Yaw.NORTH, Pitch.FORWARD, new int[] {
		0, 0, 0, 0, 2, 1
	}),
	SOUTH_FORWARD(Yaw.SOUTH, Pitch.FORWARD, new int[] {
		3, 3, 0, 0, 1, 2
	}),
	WEST_FORWARD(Yaw.WEST, Pitch.FORWARD, new int[] {
		1, 2, 2, 1, 0, 0
	}),
	EAST_FORWARD(Yaw.EAST, Pitch.FORWARD, new int[] {
		2, 1, 1, 2, 0, 0
	}),
	NORTH_UP(Yaw.NORTH, Pitch.UP, new int[] {
		3, 3, 0, 0, 0, 0
	}),
	SOUTH_UP(Yaw.SOUTH, Pitch.UP, new int[] {
		0, 0, 0, 0, 0, 0
	}),
	WEST_UP(Yaw.WEST, Pitch.UP, new int[] {
		1, 1, 0, 0, 0, 0
	}),
	EAST_UP(Yaw.EAST, Pitch.UP, new int[] {
		2, 2, 0, 0, 0, 0
	}),
	NORTH_BACKWARD(Yaw.NORTH, Pitch.BACKWARD, new int[] {
		3, 3, 3, 3, 1, 2
	}),
	SOUTH_BACKWARD(Yaw.SOUTH, Pitch.BACKWARD, new int[] {
		0, 0, 3, 3, 2, 1
	}),
	WEST_BACKWARD(Yaw.WEST, Pitch.BACKWARD, new int[] {
		2, 1, 1, 2, 3, 3
	}),
	EAST_BACKWARD(Yaw.EAST, Pitch.BACKWARD, new int[] {
		1, 2, 2, 1, 3, 3
	}),
	NORTH_DOWN(Yaw.NORTH, Pitch.DOWN, new int[] {
		0, 0, 3, 3, 3, 3
	}),
	SOUTH_DOWN(Yaw.SOUTH, Pitch.DOWN, new int[] {
		3, 3, 3, 3, 3, 3
	}),
	WEST_DOWN(Yaw.WEST, Pitch.DOWN, new int[] {
		1, 1, 3, 3, 3, 3
	}),
	EAST_DOWN(Yaw.EAST, Pitch.DOWN, new int[] {
		2, 2, 3, 3, 3, 3
	});
	...
	private BlockRotation(Yaw yaw, Pitch pitch, int[] uvRotations)
	{
		this.yaw = yaw;
		this.pitch = pitch;
		this.uvRotations = new int[] {
			uvRotations[0], uvRotations[1], uvRotations[4], uvRotations[5], uvRotations[2], uvRotations[3], 0
		};
