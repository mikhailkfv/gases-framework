...
* Open your run configurations and add the following program argument to both Client and Server: *-Dfml.coreMods.load=glenn.gasesframework.core.EDFMLLoadingPlugin*